    ...
    <div className="w-[800px]">
      <div className="w-full flex flex-col justify-start items-center bg-gray-200 p-4 h-full rounded-2xl">
        ...
        >
          ...
          <div
            className={`relative flex items-start justify-evenly w-full ${
          ...
          >
            ...
            <div
              className={`absolute top-[110px] left-1/2 -translate-x-1/2 -translate-y-1/2 ${
                selections.length === 0 ? "opacity-100" : "opacity-0"
              } transition-opacity duration-200`}
            >
              <div className="font-nunito text-center text-white bg-gray-600 p-2 rounded-lg">
                No Selections
              </div>
            </div>
          </div>
